    ...
    public class MoreMenuVideoDialogFragment : BottomSheetDialogFragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                FontUtils.SetTextViewIcon(FontsIconFrameWork.IonIcons, QualityIcon, IonIconsFonts.AndroidSettings);
                FontUtils.SetTextViewIcon(FontsIconFrameWork.IonIcons, PlaybackSpeedIcon, IonIconsFonts.Speedometer);
                FontUtils.SetTextViewIcon(FontsIconFrameWork.IonIcons, HelpFeedbackIcon, IonIconsFonts.HelpCircled);
                FontUtils.SetTextViewIcon(FontsIconFrameWork.IonIcons, MakeOfflineIcon, IonIconsFonts.Videocamera);
                        ...
                        MaterialDialog dialog = new MaterialDialog.Builder(Controller.ActivityContext).Theme(AppSettings.SetTabDarkTheme ? AFollestad.MaterialDialogs.Theme.Dark : AFollestad.MaterialDialogs.Theme.Light)
                            ...
                            .PositiveText(Resource.String.Lbl_Submit).OnPositive((materialDialog, action) =>
                            {
                                try
                                {
                                    ...
                                    {
                                        PollyController.RunRetryPolicyFunction(new List<Func<Task>> { () => RequestsAsync.Video.ReportCopyRightVideos_Http(Controller.VideoData.Id, TxtMessage.Text) });
        ...
        private void HelpFeedbackLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                LibrarySynchronizer.OnMenuHelpClick(Controller.VideoData);
