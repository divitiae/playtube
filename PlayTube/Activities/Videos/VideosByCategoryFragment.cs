    ...
    public class VideosByCategoryFragment : RecyclerViewDefaultBaseFragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private void FilterButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MaterialDialog.Builder dialogList = new MaterialDialog.Builder(Context).Theme(AppSettings.SetTabDarkTheme ? Theme.Dark : Theme.Light);
        ...
        private async Task LoadDataAsync(string offset = "0")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                var (apiStatus, respond) = await RequestsAsync.Video.Get_Videos_By_Category_Http(IdCategory, IdSubCategory, "25", offset);
