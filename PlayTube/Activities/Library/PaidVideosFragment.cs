    ...
    public class PaidVideosFragment : RecyclerViewDefaultBaseFragment
    {
        ...
        private void InitToolbar(View view)
        {
            try
            {
                ...
                if (toolbar != null)
                {
                    string title = Context.GetString(Resource.String.Lbl_Paid_videos);
        ...
        private async Task LoadDataAsync(string offset = "0")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                var (apiStatus, respond) = await RequestsAsync.Video.PaidVideos_Http("25", offset, "videos");
                if (apiStatus != 200 || !(respond is GetPaidVideosListObject result) || result.VideoList == null)
                {
                    MainScrollEvent.IsLoading = false; 
