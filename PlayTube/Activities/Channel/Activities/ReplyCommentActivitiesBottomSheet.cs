    ...
    public class ReplyCommentActivitiesBottomSheet : BottomSheetDialogFragment
    {
        ...
        private void LoadReplies()
        {
            try
            {
                ...
                MAdapter.ReplyList = new ObservableCollection<ReplyObject>(Comment.CommentReplies);
        ...
        private void ReplyAdapterOnAvatarClick(object sender, AvatarReplyAdapterClickEventArgs e)
        {
            try
            {
                GlobalContext.ShowUserChannelFragment(e.Class.ReplyUserData, e.Class.UserId.ToString());
            }
            catch (Exception exception)
            {
                Console.WriteLine(exception);
        ...
        private async Task LoadDataAsync(string offset = "0")
        {
            ...
            if (Methods.CheckConnectivity())
            {
                ...
                var (apiStatus, respond) = await RequestsAsync.Activities.GetReplyActivity_Http(Comment.Id.ToString(), "25", offset);
