...
namespace PlayTube.Activities.SettingsPreferences
{
    ...
    public class VerificationActivity : AppCompatActivity
    {
            ...
            try
            {
                ...
                {  
                    ...
                    else
                    {
                        ...
                        var (apiStatus, respond) = await RequestsAsync.Global.Verification_Http(FirstNameEdit.Text, LastNameEdit.Text, MessagesEdit.Text, PathImage);
                        if (apiStatus == 200)
                        {
