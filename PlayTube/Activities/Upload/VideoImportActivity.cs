...
namespace PlayTube.Activities.Upload
{
    ...
    public class VideoImportActivity : AppCompatActivity 
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                {
                    Url = Client.WebsiteUrl + "/import-video?cookie=" + UserDetails.Cookie + "&mode=night";
                }
                else
                {
                    Url = Client.WebsiteUrl + "/import-video?cookie=" + UserDetails.Cookie;
                }
